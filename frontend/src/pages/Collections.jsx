...
const Collections = () => {
  ...
  const toggleCategory = (e)=>{
    // value already present → remove it
  ...
  const applyFilter = ()=>{
    let productsCopy = products.slice();  //creating copy of products
  ...
  const sortProduct = ()=>{
    let fpCopy = filterProducts.slice()  //creating copy of filtered products
